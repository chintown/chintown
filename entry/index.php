    ...
    <div class="page" data-title="Mike Chen">
        <div id="main" class="wrapper row-fluid">
            <div class="span8 text-center">
                ...
                <p id="description">I make <a href="javascript:void(0)">homemade things</a> <br>and explore <a href="https://www.flickr.com/photos/chintown/sets/72157632408730031/" target="_blank">hidden joys</a>.</p>
            </div>
