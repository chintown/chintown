...
if (DEV_MODE) { ?>
        <script type="text/javascript" src="<?=PARENT_WEB_PATH?>/js/vendor/ajax.js"></script>
        <script type="text/javascript" src="<?=PARENT_WEB_PATH?>/js/vendor/dpd.js"></script>
        <script type="text/javascript" src="<?=PARENT_WEB_PATH?>/js/vendor/Class.js"></script>
        <script type="text/javascript" src="<?=PARENT_WEB_PATH?>/js/vendor/jquery.tmpl.js"></script>
        <script type="text/javascript" src="<?=PARENT_WEB_PATH?>/js/vendor/jquery-ui-1.9.2.custom.js"></script>
<?php } else { ?>
